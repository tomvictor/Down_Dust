...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x0076, 0x007D, 0x00AC, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x640E, 0x460E, 0x7001, 0x14AD, 0x0001, 0x0C67, 0xADB7, 0x705D, 0x6003, 0x14BA, 
    /*0x0100*/ 0x7041, 0x1462, 0xFB4D, 0x8609, 0x7101, 0x6431, 0x2531, 0xA6FE, 0xFB00, 0x7018, 0xFB4C, 0x7003, 0xFB4C, 0xFD47, 0xFB4C, 0x1465, 
    /*0x0120*/ 0x6403, 0x001F, 0x8B2C, 0xFDB1, 0x8902, 0x0C74, 0x14C0, 0x0875, 0x1874, 0x2873, 0x9D2A, 0x9E04, 0x1001, 0x1C75, 0x440F, 0x04A3, 
    /*0x0140*/ 0x1000, 0x1C75, 0x640F, 0x1875, 0x8D29, 0xB603, 0x086C, 0x8201, 0x0C6C, 0x0001, 0x0C67, 0xADB7, 0xADB7, 0xF007, 0x1462, 0x86FF, 
    /*0x0160*/ 0x63F8, 0xEB51, 0x8680, 0x6000, 0xED8F, 0xEB49, 0xFD47, 0xEB49, 0x1465, 0xADB7, 0xFB0C, 0xEDA4, 0xEB09, 0x640B, 0xCDB1, 0xADB7, 
    /*0x0180*/ 0x1462, 0x7079, 0xFB55, 0x71FB, 0xFB54, 0xFD47, 0xFB54, 0x1465, 0x4431, 0x4400, 0xADB7
};
...
//  cfg         input       output      state       
    0x001010E6, 0x00000000, 0x001010E8, 0x001010EA  // Dusk2Dawn
};
