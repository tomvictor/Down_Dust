...
build-1299842911:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1299842911-inproc

build-1299842911-inproc: ../empty_min.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-1299842911
configPkg/compiler.opt: build-1299842911
configPkg/: build-1299842911
